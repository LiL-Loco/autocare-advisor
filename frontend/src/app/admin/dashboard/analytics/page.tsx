        ...
        realtime: {
          ...
          recentActivity: [
            ...
            },
            {
              type: 'partner',
              description:
                'Neuer Partner registriert: Detailing Studio München',
              ...
              <CardContent>
                <div className="h-80 bg-gray-100 rounded-lg flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p className="text-sm">
                      Revenue trends over time would be displayed here
                    </p>
                  </div>
                </div>
              </CardContent>
