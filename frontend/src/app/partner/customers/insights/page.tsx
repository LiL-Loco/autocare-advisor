    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">KI-Insights werden generiert...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Intelligente Kundenanalysen mit maschinellem Lernen und prädiktiven
            Modellen
          </p>
        </div>
        ...
        <TabsContent value="predictions" className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>Churn-Welle vorhergesagt:</strong> Modell identifiziert
                potenzielle Abwanderung von 89 Kunden in den nächsten 45 Tagen.
