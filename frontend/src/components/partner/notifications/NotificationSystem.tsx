  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      title: 'New Sale!',
      message:
        'Your Castrol GTX 5W-40 product received a purchase. Customer: Michael S.',
      timestamp: new Date(Date.now() - 1000 * 60 * 10), // 10 minutes ago
      read: false,
      actionRequired: false,
      category: 'Sales',
      data: { productId: 'p123', customerId: 'c456', amount: 45.9 },
    },
    {
      id: '2',
      type: 'engagement',
      ...
      message:
        'Your Bosch Oil Filter has received 25+ views today. Consider increasing stock.',
    ...
    },
    {
      ...
      message:
        'Mann-Filter C 25 114/1 is running low (3 units left). Restock recommended.',
    ...
    },
    {
      ...
      message:
        'Your weekly performance report is ready. Total views: 456, Sales: €234.50',
      timestamp: new Date(Date.now() - 1000 * 60 * 60 * 8), // 8 hours ago
      read: true,
      actionRequired: false,
      category: 'Reports',
      data: { views: 456, sales: 234.5 },
    },
    {
      id: '5',
      type: 'system',
      ...
      message:
        'CSV import failed for brake_products_2024.csv. Please check file format and try again.',
    ...
    },
    {
      ...
      message:
        '15 products successfully updated with new pricing and availability.',
        ...
        const randomNotifications = [
          {
            ...
            message:
              'Your air filter products are getting increased attention.',
            timestamp: new Date(),
            read: false,
            actionRequired: false,
            category: 'Marketing',
        ...
        <div className="flex space-x-2">
          {[
            ...
            },
            {
              key: 'engagement',
              label: 'Engagement',
              count: notifications.filter((n) => n.type === 'engagement')
                .length,
            },
            {
              key: 'warning',
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          engagementAlerts: e.target.checked,
                        })
                      }
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
