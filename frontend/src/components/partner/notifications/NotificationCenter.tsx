...
interface Notification {
  ...
  timestamp: string;
  read: boolean;
  category: 'order' | 'product' | 'system' | 'billing' | 'marketing' | 'analytics';
...
const NotificationCenter: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'notifications' | 'preferences' | 'templates' | 'analytics'>('notifications');
  ...
  useEffect(() => {
    ...
    const mockNotifications: Notification[] = [
      {
        ...
        message: 'You have received a new order for 3x Premium Car Wax (€89.99)',
        ...
        actions: [
          ...
          { label: 'Process', action: '/orders/12345/process', style: 'secondary' }
        ],
      ...
      },
      {
        ...
        message: 'Product "Tire Shine Spray" is running low in stock (5 units remaining)',
        timestamp: '2024-08-26T13:15:00Z',
        read: false,
        category: 'product',
        priority: 'medium',
        actions: [
          { label: 'Restock', action: '/products/restock/678', style: 'primary' }
        ],
      ...
      },
      {
        ...
        message: 'Your August performance report is now available with detailed insights',
        timestamp: '2024-08-26T09:00:00Z',
        read: true,
        category: 'analytics',
        priority: 'low',
        actions: [
          { label: 'View Report', action: '/analytics/monthly', style: 'primary' }
        ]
      },
      {
        id: 'notif-4',
        ...
        priority: 'critical',
        actions: [
          { label: 'Update Payment', action: '/billing/payment-method', style: 'danger' },
      ...
      },
      {
        ...
        message: 'Scheduled maintenance will occur on Aug 28, 2024 from 2:00-4:00 AM UTC',
    ...
    const mockPreferences: NotificationPreferences = {
      ...
      webhook: true,
      categories: {
        order: { enabled: true, channels: ['inApp', 'email'], frequency: 'immediate' },
        product: { enabled: true, channels: ['inApp'], frequency: 'hourly' },
        billing: { enabled: true, channels: ['inApp', 'email', 'sms'], frequency: 'immediate' },
        system: { enabled: true, channels: ['inApp', 'email'], frequency: 'immediate' },
    ...
    const mockTemplates: NotificationTemplate[] = [
      {
        ...
        content: 'Thank you for your order! Order {{orderNumber}} has been confirmed for {{amount}}.',
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8">
          {[
            ...
            { key: 'preferences', label: 'Preferences', count: Object.keys(preferences.categories).length },
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <span className={`inline-flex px-2 py-0.5 text-xs font-medium rounded-full border ${getPriorityColor(notification.priority)}`}>
                              ...
                              {notification.actions.map((action, index) => (
                                <button
                                  ...
                                  className={`px-3 py-1 text-xs font-medium rounded transition-colors ${
                                    action.style === 'primary' ? 'bg-blue-100 text-blue-700 hover:bg-blue-200' :
            ...
            {filteredNotifications.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  {showUnreadOnly ? 'No unread notifications found' : 'All caught up! No notifications to display.'}
                </p>
              </div>
            )}
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={setting.key} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <input
                    type="checkbox"
                    checked={preferences[setting.key as keyof Omit<NotificationPreferences, 'categories'>]}
                    ...
                    <div className="space-y-4 pl-4 border-l-2 border-blue-100">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(['inApp', 'email', 'sms', 'webhook'] as const).map(channel => (
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  setPreferences(prev => ({
                                    ...
                                    categories: {
                                      ...prev.categories,
                                      [category]: { ...settings, channels: updatedChannels }
                                    }
                                  }));
                                }}
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setPreferences(prev => ({
                            ...
                            categories: {
                              ...prev.categories,
                              [category]: { ...settings, frequency: e.target.value as any }
                            }
                          }))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {template.variables.map(variable => (
                        <code key={variable} className="px-2 py-0.5 bg-blue-100 text-blue-800 rounded text-xs">
                          {`{{${variable}}}`}
                        </code>
                      ))}
                    </div>
      ...
      {activeTab === 'analytics' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Notifications by Category</h3>
              <div className="space-y-3">
