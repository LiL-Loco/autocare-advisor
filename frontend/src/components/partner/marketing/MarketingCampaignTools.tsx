...
const MarketingCampaignTools: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'campaigns' | 'builder' | 'insights'>('overview');
    ...
    const mockTemplates: CampaignTemplate[] = [
      {
        ...
        type: 'Multi-Channel',
        description: 'Comprehensive campaign for new product launches with email, social, and PPC components',
      ...
      },
      {
        ...
        type: 'Email + Social',
        description: 'Targeted seasonal campaigns for automotive maintenance reminders',
    ...
    const mockInsights: MarketingInsight[] = [
      {
        ...
        description: 'Subject lines with urgency words show 23% higher open rates',
        impact: 'high',
      ...
      },
      {
        ...
        description: 'Professional mechanics segment shows high engagement but low campaign allocation',
        impact: 'medium',
      ...
      },
      {
        ...
        description: 'Summer promotion campaign is 15% over budget with 2 weeks remaining',
        impact: 'high',
        category: 'alert',
        actionRequired: true
      }
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Marketing Campaign Tools</h1>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{formatCurrency(16000)}</p>
                </div>
              </div>
              <div className="mt-4">
                <div className="flex items-center">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{formatCurrency(47640)}</p>
                </div>
              </div>
              <div className="mt-4">
                <div className="flex items-center">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center">
                        ...
                        <span className={`ml-3 inline-flex px-2 py-1 text-xs font-medium rounded-full border ${getStatusColor(campaign.status)}`}>
                          {campaign.status}
                        </span>
                      </div>
                      <div className="mt-2 grid grid-cols-2 lg:grid-cols-6 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <span className="ml-1 font-medium">{formatPercentage(campaign.performance.ctr)}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">CPC:</span>
                          <span className="ml-1 font-medium">€{campaign.performance.cpc.toFixed(2)}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">ROAS:</span>
                          <span className="ml-1 font-medium">{campaign.performance.roas.toFixed(1)}x</span>
                        </div>
                        <div>
                          <span className="text-gray-500">Revenue:</span>
                          <span className="ml-1 font-medium">{formatCurrency(campaign.performance.revenue)}</span>
                        </div>
                      </div>
                      <div className="mt-3">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {campaigns.map((campaign) => (
                  <tr key={campaign.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900 capitalize">{campaign.type}</td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm">
                        <div className="font-medium text-gray-900">{formatCurrency(campaign.budget)}</div>
                        <div className="text-gray-500">{formatCurrency(campaign.spent)} spent</div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm space-y-1">
                        <div>CTR: {formatPercentage(campaign.performance.ctr)}</div>
                    ...
                    <td className="px-6 py-4 text-sm font-medium">
                      <div className="flex space-x-2">
                        ...
                        <button className="text-green-600 hover:text-green-900">Clone</button>
      ...
      {activeTab === 'builder' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Campaign Templates</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {templates.map(template => (
                <div key={template.id} className="border border-gray-200 rounded-lg p-6 hover:border-blue-300 transition-colors cursor-pointer">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{template.expectedROAS}x</span>
                    </div>
                    <div className="flex justify-between">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center">
                    ...
                    <span className={`ml-3 inline-flex px-2 py-1 text-xs font-medium rounded-full border ${getImpactColor(insight.impact)}`}>
