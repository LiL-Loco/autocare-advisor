...
export default function CustomerInsights() {
  ...
  const filteredCustomers = useMemo(() => {
    return customers.filter(customer => {
      ...
      const matchesBrand = filters.vehicleBrand === 'all' || customer.vehicleBrand === filters.vehicleBrand;
  ...
  const customerStats = useMemo(() => ({
    ...
    totalEngagement: customers.reduce((sum, c) => sum + c.engagement.viewsLast30Days, 0),
    averageSatisfaction: customers.reduce((sum, c) => sum + c.satisfaction, 0) / customers.length,
    totalRevenue: customers.reduce((sum, c) => sum + (c.purchaseHistory.total * c.purchaseHistory.averageOrderValue), 0)
  }), [customers]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Understand your customers and their preferences</p>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-2xl font-bold text-gray-900">{customerStats.totalEngagement}</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-2xl font-bold text-gray-900">{customerStats.averageSatisfaction.toFixed(1)}</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-2xl font-bold text-gray-900">€{customerStats.totalRevenue.toFixed(0)}</p>
          ...
          <div className="flex items-center space-x-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <DropdownMenuItem onClick={() => setFilters({...filters, status: 'potential'})}>
                  Potential
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem onClick={() => setFilters({...filters, vehicleBrand: 'all'})}>
                  All Brands
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setFilters({...filters, vehicleBrand: 'BMW'})}>
                  BMW
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setFilters({...filters, vehicleBrand: 'Audi'})}>
                  Audi
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setFilters({...filters, vehicleBrand: 'Mercedes'})}>
                  Mercedes
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem onClick={() => setFilters({...filters, sortBy: 'lastActivity'})}>
                  Last Activity
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setFilters({...filters, sortBy: 'name'})}>
                  Name
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setFilters({...filters, sortBy: 'engagement'})}>
                  Engagement
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setFilters({...filters, sortBy: 'satisfaction'})}>
                  Satisfaction
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{customer.engagement.viewsLast30Days}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Clicks:</span>
                <span className="font-medium">{customer.engagement.clicksLast30Days}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Recommendations:</span>
                <span className="font-medium">{customer.engagement.recommendationsUsed}</span>
              </div>
            </div>
            ...
            <div className="mt-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  <Star className={`h-4 w-4 mr-1 ${getSatisfactionColor(customer.satisfaction)}`} />
                  <span className={`font-medium ${getSatisfactionColor(customer.satisfaction)}`}>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{customer.purchaseHistory.total}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Avg Order:</span>
                <span className="font-medium">€{customer.purchaseHistory.averageOrderValue.toFixed(2)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Last Purchase:</span>
                <span className="font-medium">
                  {new Date(customer.purchaseHistory.lastPurchase).toLocaleDateString()}
                </span>
              </div>
            </div>
