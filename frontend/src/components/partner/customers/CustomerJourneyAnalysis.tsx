      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Understand your customers' path to purchase and identify
        ...
        <div className="space-y-4">
          {journeySteps.map((step, index) => {
            ...
            const dropOffRate = prevStep
              ? ((prevStep.customers - step.customers) / prevStep.customers) *
                100
              : 0;
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <div className="mt-2 bg-gray-200 rounded-full h-3 relative overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${
                            (step.customers / journeySteps[0].customers) * 100
                          }%`,
                        }}
                      ></div>
                    </div>
          ...
          <div className="space-y-4">
            {Object.entries(segmentStats).map(([segment, count]) => (
              <div key={segment} className="flex items-center justify-between">
                <div className="flex items-center">
                  <span
                    className={`inline-flex px-3 py-1 text-sm font-medium rounded-full border ${getSegmentColor(
                      segment
                    )}`}
                  >
                    {segment}
